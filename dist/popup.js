...
const downloadButtonText = document.getElementById('download-base-text');
document.addEventListener("DOMContentLoaded", function () {
    downloadButton = document.getElementById("vid-download-button");
    linkInput = document.getElementById("videolink");
    fileNameInput = document.getElementById("videoname");
    mp3Button = document.getElementById("mp3Button");
    mp4Button = document.getElementById("mp4Button");
    notification = document.getElementById("error-notification");
...
function updateYouTubeUrlInput(event) {
...
function clear() {
    ...
    downloadAnimation === null || downloadAnimation === void 0 ? void 0 : downloadAnimation.classList.add('hidden');
    mp3Button.classList.remove("selected");
    mp4Button.classList.remove("selected");
    fileFormat = "";
    fileName = "myfile";
